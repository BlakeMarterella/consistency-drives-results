export const firebaseErrors = {
    ...
    "auth/invalid-login-credentials": "Invalid login credentials. Please double-check and try again.",
...
/**
 * Returns the error message associated with the given Firebase Auth error code.
 * If the error code is not found in the firebaseErrors object, returns a default message.
 *
 * @param {string} errorCode - The Firebase Auth error code.
 * @returns {string} - The error message associated with the given error code, or a default message if the error code is not found.
 */
export function getFirebaseErrorMessage(errorCode: string): string {
    return firebaseErrors[errorCode] || 'An unknown error occurred.';
}